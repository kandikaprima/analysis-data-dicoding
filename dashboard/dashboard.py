...
##Read Data
Aotizhongxin = pd.read_csv('https://raw.githubusercontent.com/kandikaprima/analysis-data-dicoding/main/dashboard/PRSA_Data_Aotizhongxin_20130301-20170228.csv',usecols = ['year','month','RAIN','TEMP'])
Changping = pd.read_csv('https://raw.githubusercontent.com/kandikaprima/analysis-data-dicoding/main/dashboard/PRSA_Data_Changping_20130301-20170228.csv',usecols = ['year','month','RAIN','TEMP'])
